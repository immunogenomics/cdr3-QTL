...
ofile <- paste0("assoc/HIP/celiac_score/length_v1/L", length,"_P", pos ,".lm.v1.txt.gz")
...
load("Celiac_haplotype_score_v1.RData") # rascore_mat: N x haplotypee
load("Celiac_haplotype_v1.RData")
