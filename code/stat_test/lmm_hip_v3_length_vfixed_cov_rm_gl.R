...
length="13"; pos="6"
 ...
 #ofile <- paste0("assoc/HIP/lmm/v3_length_vfixed_cov_rm_gl/L", length, ".", pos, ".lmm.v3_length.txt.gz")

 #phenotype
pdata <- read.table(paste0("../../data/tcr_phenotype/L", length, "_P", pos, "_rm_gl/vgene_cond_single_aa_usage_ratio.txt.gz"),
