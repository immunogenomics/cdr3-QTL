...
pos <- 6
 ...
 #ofile <- paste0("../../data/tcr_phenotype/L", length,"_P", pos ,".lm.v1.txt.gz")
...
load("../../data/genotype/RA_haplotype_score_v1.RData") # rascore_mat: N x haplotypee
load("../../data/genotype/RA_haplotype_v1.RData")
