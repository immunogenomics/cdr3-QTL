...
ofile <- paste0("assoc/HIP/lmm/v3_length_jfixed_cov/L", length, ".", pos, ".lmm.v3_length.txt.gz")

 #phenotype
pdata <- read.table(paste0("phenotype.freq3/L", length, "_P", pos, "/jgene_cond_single_aa_usage_ratio.txt.gz"),
